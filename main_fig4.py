...
for i in range(Q):
    D_halfinv_temp,M_temp,temp3,v_temp,CT_temp3=main(G,D,Dhalfinv,S[i])
    CT_temp=C_T(temp3[-6:],alpha,S[i])
    #print (i,CT_temp,CT_temp3)
    CT_array3[i]=CT_temp3
print ('new method')  
...
plt.semilogx(S,CT_array1,linewidth=2,linestyle=(0,(1,6)),label='direct')
plt.semilogx(S,CT_array2,linewidth=2,linestyle='dotted',label='SPADE')
plt.semilogx(S,CT_array3,linewidth=3,linestyle='-',label='new')
