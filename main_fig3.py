...
M = 2
nmax = 150
n=10  #note for separate SPADE method, when L=20, we must include a sufficiently higher order phi_k to make it normalized
W=50
S=1000
N_measure=50
...
plt.loglog(alpha,beta1_fit[4,:],linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6000')
#plt.loglog(alpha,1/np.abs(l1[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
#plt.loglog(alpha,1/np.abs(l1[-2,:])-1,linewidth=2,linestyle='-',label='bet2')
#plt.loglog(alpha,1/np.abs(l1[-3,:])-1,linewidth=2,linestyle='dotted',label='bet3')
#plt.loglog(alpha,1/np.abs(l1[-4,:])-1,linewidth=2,linestyle='dashed',label='bet4')
#plt.loglog(alpha,1/np.abs(l1[-5,:])-1,linewidth=2,linestyle='-.',label='bet5000')
#plt.loglog(alpha,1/np.abs(l1[-6,:])-1,linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6000')
#plt.legend(fontsize=17, loc='lower center', bbox_to_anchor=(0.5, 1.02), ncol=3)
#plt.legend(fontsize=17,loc='center left', bbox_to_anchor=(1, 0.5))  
