...
if __name__ == '__main__':
    ...
    for i in range(15):
        ...
        beta13=1/(l3[-i-1,p])
        beta23=1/(l3[-i-1,q])
        temp11=np.log(beta11/beta21)
        temp12=np.log(beta12/beta22)
        temp13=np.log(beta13/beta23)
        temp2=np.log(alpha[p])-np.log(alpha[q])
        #print (i,'direct SPADE',temp11/temp2,'new',temp12/temp2)
        print("{:<5} direct imaging {:>10.4f} direct SPADE {:>10.4f} new {:>10.4f}".format(i, temp11/temp2, temp12/temp2, temp13/temp2))
    ...
    threshold=1e15
    beta1_fit=np.zeros([5,Q])
    k11=((1/np.abs(l1[-2,:])-1)/alpha**(0))[-2]
    k12=((1/np.abs(l1[-3,:])-1)/alpha**(-2))[-2]
    k13=((1/np.abs(l1[-4,:])-1)/alpha**(-2))[-2]
    k14=((1/np.abs(l1[-5,:])-1)/alpha**(-4))[-2]
    k15=((1/np.abs(l1[-6,:])-1)/alpha**(-4))[-2]
    for i in range(Q):
        if (1/np.abs(l1[-2,:])-1)[i]>threshold:
            beta1_fit[0,i]=k11*alpha[i]**(-0)
        else:
            beta1_fit[0,i]=(1/np.abs(l1[-2,:])-1)[i]
            
        if (1/np.abs(l1[-3,:])-1)[i]>threshold:
            beta1_fit[1,i]=k12*alpha[i]**(-2)
        else:
            beta1_fit[1,i]=(1/np.abs(l1[-3,:])-1)[i]
        
        if (1/np.abs(l1[-4,:])-1)[i]>threshold:
            beta1_fit[2,i]=k13*alpha[i]**(-2)
        else:
            beta1_fit[2,i]=(1/np.abs(l1[-4,:])-1)[i]
    
        if (1/np.abs(l1[-5,:])-1)[i]>threshold:
            beta1_fit[3,i]=k14*alpha[i]**(-4)
        else:
            beta1_fit[3,i]=(1/np.abs(l1[-5,:])-1)[i]
            
        if (1/np.abs(l1[-6,:])-1)[i]>threshold:
            #print (i,(1/np.abs(l1[-6,:])-1)[i])
            beta1_fit[4,i]=k15*alpha[i]**(-4)
        else:
            beta1_fit[4,i]=(1/np.abs(l1[-6,:])-1)[i]
            
    
    beta2_fit=np.zeros([5,Q])
    k21=((1/np.abs(l2[-2,:])-1)/alpha**(0))[-2]
    k22=((1/np.abs(l2[-3,:])-1)/alpha**(-2))[-2]
    k23=((1/np.abs(l2[-4,:])-1)/alpha**(-2))[-2]
    k24=((1/np.abs(l2[-5,:])-1)/alpha**(-4))[-2]
    k25=((1/np.abs(l2[-6,:])-1)/alpha**(-4))[-2]
    for i in range(Q):
        if (1/np.abs(l2[-2,:])-1)[i]>threshold:
            beta2_fit[0,i]=k21*alpha[i]**(-0)
        else:
            beta2_fit[0,i]=(1/np.abs(l2[-2,:])-1)[i]
            
        if (1/np.abs(l2[-3,:])-1)[i]>threshold:
            beta2_fit[1,i]=k22*alpha[i]**(-2)
        else:
            beta2_fit[1,i]=(1/np.abs(l2[-3,:])-1)[i]
        
        if (1/np.abs(l2[-4,:])-1)[i]>threshold:
            beta2_fit[2,i]=k23*alpha[i]**(-2)
        else:
            beta2_fit[2,i]=(1/np.abs(l2[-4,:])-1)[i]
    
        if (1/np.abs(l2[-5,:])-1)[i]>threshold:
            beta2_fit[3,i]=k24*alpha[i]**(-4)
        else:
            beta2_fit[3,i]=(1/np.abs(l2[-5,:])-1)[i]
            
        if (1/np.abs(l2[-6,:])-1)[i]>threshold:
            #print (i,(1/np.abs(l1[-6,:])-1)[i])
            beta2_fit[4,i]=k25*alpha[i]**(-4)
        else:
            beta2_fit[4,i]=(1/np.abs(l2[-6,:])-1)[i]
    ...
    #plt.loglog(alpha,1/np.abs(l1[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.loglog(alpha,beta1_fit[0,:],linewidth=2,linestyle='-',label='bet2')
    plt.loglog(alpha,beta1_fit[1,:],linewidth=2,linestyle='dotted',label='bet3')
    plt.loglog(alpha,beta1_fit[2,:],linewidth=2,linestyle='dashed',label='bet4')
    plt.loglog(alpha,beta1_fit[3,:],linewidth=2,linestyle='-.',label='bet5000')
    #plt.loglog(alpha,1/np.abs(l1[-5,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.loglog(alpha,beta1_fit[4,:],linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6000')
    #plt.loglog(alpha,1/np.abs(l1[-6,:])-1,linewidth=2,linestyle='-',label='bet1')
    ...
    #foo_fig.savefig('direct_beta_M'+str(M)+'L'+str(L)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    ...
    #ax.xaxis.set_major_formatter(xmajorFormatter)
    #ax.yaxis.set_major_locator(ymajorLocator)
    bx.spines['bottom'].set_linewidth(2)
    bx.spines['left'].set_linewidth(2)
    bx.spines['top'].set_linewidth(2)
    bx.spines['right'].set_linewidth(2)
    plt.xticks(fontsize=25)
    plt.yticks(fontsize=25)
    #plt.xlim([5,D_array[-1]+10])
    #plt.ylim([0,0.55])
    ...
    #plt.loglog(alpha,1/np.abs(l2[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    #plt.loglog(alpha,1/np.abs(l2[-2,:])-1,linewidth=2,linestyle='-',label='bet2')
    #plt.loglog(alpha,1/np.abs(l2[-3,:])-1,linewidth=2,linestyle='dotted',label='bet3')
    #plt.loglog(alpha,1/np.abs(l2[-4,:])-1,linewidth=2,linestyle='dashed',label='bet4')
    #plt.loglog(alpha,1/np.abs(l2[-5,:])-1,linewidth=2,linestyle='-.',label='bet5')
    #plt.loglog(alpha,1/np.abs(l2[-6,:])-1,linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6')
    
    plt.loglog(alpha,beta2_fit[0,:],linewidth=2,linestyle='-',label='bet2')
    plt.loglog(alpha,beta2_fit[1,:],linewidth=2,linestyle='dotted',label='bet3')
    plt.loglog(alpha,beta2_fit[2,:],linewidth=2,linestyle='dashed',label='bet4')
    plt.loglog(alpha,beta2_fit[3,:],linewidth=2,linestyle='-.',label='bet5000')
    plt.loglog(alpha,beta2_fit[4,:],linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6000')
    ...
    foo_fig = plt.gcf() # 'get current figure'
    #foo_fig.savefig('SPADE_beta_M'+str(M)+'L'+str(L)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    ...
    #ax.xaxis.set_major_formatter(xmajorFormatter)
    #ax.yaxis.set_major_locator(ymajorLocator)
    cx.spines['bottom'].set_linewidth(2)
    cx.spines['left'].set_linewidth(2)
    cx.spines['top'].set_linewidth(2)
    cx.spines['right'].set_linewidth(2)
    plt.xticks(fontsize=25)
    plt.yticks(fontsize=25)
    #plt.xlim([5,D_array[-1]+10])
    #plt.ylim([0,0.55])
    ...
    #plt.loglog(alpha,1/np.abs(l3[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.loglog(alpha,1/np.abs(l3[-2,:])-1,linewidth=2,linestyle='-',label='bet2')
    plt.loglog(alpha,1/np.abs(l3[-3,:])-1,linewidth=2,linestyle='dotted',label='bet3')
    plt.loglog(alpha,1/np.abs(l3[-4,:])-1,linewidth=2,linestyle='dashed',label='bet4')
    plt.loglog(alpha,1/np.abs(l3[-5,:])-1,linewidth=2,linestyle='-.',label='bet5')
    plt.loglog(alpha,1/np.abs(l3[-6,:])-1,linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6')
    
    #plt.legend(fontsize=17,loc='center left', bbox_to_anchor=(1, 0.5))  
    
    
    foo_fig = plt.gcf() # 'get current figure'
    #foo_fig.savefig('new_beta_M'+str(M)+'L'+str(L)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    
    plt.show()
    
    
    xarray=np.linspace(1,19,19)
    
    plt.figure()
    cx=plt.subplot(1,1,1)
    
    xmajorLocator = MultipleLocator(5)  # x ticks at multiples of 5
    #xmajorLocator   = MultipleLocator(5) #å°†xä¸»åˆ»åº¦æ ‡ç­¾è®¾ç½®ä¸º20çš„å€æ•°
    #ymajorLocator   = MultipleLocator(1000000) #å°†yä¸»åˆ»åº¦æ ‡ç­¾è®¾ç½®ä¸º20çš„å€æ•°
    #ymajorLocator = LogLocator(base=10)  # LogLocator for 10^4n
    #xmajorFormatter = FormatStrFormatter('%1.1f') #è®¾ç½®xè½´æ ‡ç­¾æ–‡æœ¬çš„æ ¼å¼
    #xminorLocator   = MultipleLocator(1) #å°†xè½´æ¬¡åˆ»åº¦æ ‡ç­¾è®¾ç½®ä¸º5çš„å€æ•°
    ...
    #plt.loglog(alpha,1/np.abs(l3[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.semilogy(xarray,(1/np.abs(l1[-20:,0])-1)[::-1][-19:],linewidth=2,linestyle='-',label='bet2')
    plt.semilogy(xarray,(1/np.abs(l1[-20:,10])-1)[::-1][-19:],linewidth=2,linestyle='--',label='bet2')
    plt.semilogy(xarray,(1/np.abs(l1[-20:,20])-1)[::-1][-19:],linewidth=2,linestyle='-.',label='bet2')
    ...
    foo_fig = plt.gcf() # 'get current figure'
    foo_fig.savefig('val_DI.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    ...
    #plt.loglog(alpha,1/np.abs(l3[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.semilogy(xarray,(1/np.abs(l2[-20:,0])-1)[::-1][-19:],linewidth=2,linestyle='-',label='bet2')
    plt.semilogy(xarray,(1/np.abs(l2[-20:,10])-1)[::-1][-19:],linewidth=2,linestyle='--',label='bet2')
    plt.semilogy(xarray,(1/np.abs(l2[-20:,20])-1)[::-1][-19:],linewidth=2,linestyle='-.',label='bet2')
    ...
    foo_fig = plt.gcf() # 'get current figure'
    foo_fig.savefig('val_sSPADE.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    ...
    #plt.loglog(alpha,1/np.abs(l3[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.semilogy(xarray,(1/np.abs(l3[-20:,0])-1)[::-1][-19:],linewidth=2,linestyle='-',label='alpha=0.1')
    plt.semilogy(xarray,(1/np.abs(l3[-20:,10])-1)[::-1][-19:],linewidth=2,linestyle='--',label='alpha=0.01')
    plt.semilogy(xarray,(1/np.abs(l3[-20:,20])-1)[::-1][-19:],linewidth=2,linestyle='-.',label='alpha=0.001')
    ...
    foo_fig = plt.gcf() # 'get current figure'
    foo_fig.savefig('val_oSPADE.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    ...
    #plt.loglog(alpha,1/np.abs(l3[-1,:])-1,linewidth=2,linestyle='-',label='bet1')
    plt.semilogy(xarray,(1/np.abs(l1[-20:,20])-1)[::-1][-19:],linewidth=2,linestyle='-',label='Direct imaging')
    plt.semilogy(xarray,(1/np.abs(l2[-20:,20])-1)[::-1][-19:],linewidth=2,linestyle='--',label='Separate SPADE')
    plt.semilogy(xarray,(1/np.abs(l3[-20:,20])-1)[::-1][-19:],linewidth=2,linestyle='-.',label='Orthogonalized SPADE')
    ...
    foo_fig = plt.gcf() # 'get current figure'
    foo_fig.savefig('val_together.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
    ...
    R0=np.concatenate((r3[-M:,-1,p], r3[:C,-1,p]))
    R1=np.concatenate((r3[-M:,-2,p], r3[:C,-2,p]))
    R2=np.concatenate((r3[-M:,-3,p], r3[:C,-3,p]))
    R3=np.concatenate((r3[-M:,-4,p], r3[:C,-4,p]))
    R4=np.concatenate((r3[-M:,-5,p], r3[:C,-5,p]))
    R5=np.concatenate((r3[-M:,-6,p], r3[:C,-6,p]))
    R6=np.concatenate((r3[-M:,-7,p], r3[:C,-7,p]))
    R7=np.concatenate((r3[-M:,-8,p], r3[:C,-8,p]))
    ...
    #plt.tight_layout()
    plt.savefig('oSPADE_vec0123_plot.png', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    #plt.tight_layout()
    plt.savefig('oSPADE_vec4567_plot.png', dpi=300, bbox_inches='tight')
    plt.show()
