...
for i in range(10):
    ...
    print("{:<5} direct imaging {:>10.4f} direct SPADE {:>10.4f} ".format(i, temp11/temp2, temp12/temp2))
...
plt.figure()
k11=((1/np.abs(l1[-2,:])-1)/alpha**(-2))[-1]
k12=((1/np.abs(l1[-3,:])-1)/alpha**(-4))[-1]
k13=((1/np.abs(l1[-4,:])-1)/alpha**(-6))[-1]
k14=((1/np.abs(l1[-5,:])-1)/alpha**(-8))[-1]
temp11=k11*alpha**(-2)
temp12=k12*alpha**(-4)
temp13=k13*alpha**(-6)
temp14=k14*alpha**(-8)
...
plt.loglog(alpha,1/np.abs(l1[-2,:])-1,linewidth=2,linestyle='dotted',label='bet2')
plt.loglog(alpha,1/np.abs(l1[-3,:])-1,linewidth=2,linestyle=(0,(1,6)),label='bet3')
...
plt.loglog(alpha,temp11,linewidth=2,linestyle='dotted',label='bet2')
plt.loglog(alpha,temp12,linewidth=2,linestyle=(0,(1,6)),label='bet3')
plt.loglog(alpha,temp13,linewidth=2,linestyle='dashed',label='bet4')
plt.loglog(alpha,temp14,linewidth=2,linestyle='-.',label='bet5000')


plt.figure()
k21=((1/np.abs(l2[-2,:])-1)/alpha**(-2))[-3]
k22=((1/np.abs(l2[-3,:])-1)/alpha**(-2))[-3]
k23=((1/np.abs(l2[-4,:])-1)/alpha**(-4))[-3]
k24=((1/np.abs(l2[-5,:])-1)/alpha**(-4))[-3]
temp21=k21*alpha**(-2)
temp22=k22*alpha**(-2)
temp23=k23*alpha**(-4)
temp24=k24*alpha**(-4)
plt.loglog(alpha,1/np.abs(l2[-2,:])-1,linewidth=2,linestyle='dotted',label='bet2')
plt.loglog(alpha,1/np.abs(l2[-3,:])-1,linewidth=2,linestyle=(0,(1,6)),label='bet3')
plt.loglog(alpha,temp21,linewidth=2,linestyle='dotted',label='bet2')
plt.loglog(alpha,temp22,linewidth=2,linestyle=(0,(1,6)),label='bet3')



plt.loglog(alpha,1/np.abs(l2[-4,:])-1,linewidth=2,linestyle='dashed',label='bet4')
plt.loglog(alpha,temp23,linewidth=2,linestyle='dashed',label='bet4')

plt.loglog(alpha,1/np.abs(l2[-5,:])-1,linewidth=2,linestyle='-.',label='bet5000')
plt.loglog(alpha,temp24,linewidth=2,linestyle='-.',label='bet5000')
...
for i in range(Q):
    ...
    if (1/np.abs(l1[-2,:])-1)[i]<1e15:
        temp11[i]=(1/np.abs(l1[-2,:])-1)[i]
        
    if (1/np.abs(l1[-3,:])-1)[i]<1e15:
        temp12[i]=(1/np.abs(l1[-3,:])-1)[i]
        
    if (1/np.abs(l1[-4,:])-1)[i]<1e15:
        temp13[i]=(1/np.abs(l1[-4,:])-1)[i]
        
    if (1/np.abs(l1[-5,:])-1)[i]<1e15:
        temp14[i]=(1/np.abs(l1[-5,:])-1)[i]
        
    
    if (1/np.abs(l2[-2,:])-1)[i]<1e15:
        temp21[i]=(1/np.abs(l2[-2,:])-1)[i]
        
    if (1/np.abs(l2[-3,:])-1)[i]<1e15:
        temp22[i]=(1/np.abs(l2[-3,:])-1)[i]
        
    if (1/np.abs(l2[-4,:])-1)[i]<1e15:
        temp23[i]=(1/np.abs(l2[-4,:])-1)[i]
        
    if (1/np.abs(l2[-5,:])-1)[i]<1e15:
        temp24[i]=(1/np.abs(l2[-5,:])-1)[i]
...
plt.loglog(alpha,temp11,linewidth=2,linestyle='dotted',label='bet2')
#plt.loglog(alpha,k12*alpha**(-4),linewidth=2,linestyle=(0,(1,6)),label='bet3')
plt.loglog(alpha,temp12,linewidth=2,linestyle='-',label='bet3')
plt.loglog(alpha,temp13,linewidth=2,linestyle='dashed',label='bet4')
plt.loglog(alpha,temp14,linewidth=2,linestyle='-.',label='bet5000')
...
foo_fig.savefig('direct_beta_W'+str(W)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
...
plt.loglog(alpha,temp21,linewidth=2,linestyle='dotted',label='bet2')
plt.loglog(alpha,temp22,linewidth=2,linestyle='-',label='bet3')
plt.loglog(alpha,temp23,linewidth=2,linestyle='dashed',label='bet4')
plt.loglog(alpha,temp24,linewidth=2,linestyle='-.',label='bet5000')
#plt.loglog(alpha,1/np.abs(l2[-6,:])-1,linewidth=2,linestyle=(0, (3, 10, 1, 10)),label='bet6')

#plt.legend(fontsize=17,loc='center', bbox_to_anchor=(0.5, 1.4), ncol=4)  


foo_fig = plt.gcf() # 'get current figure'
foo_fig.savefig('SPADE_beta_'+'W'+str(W)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')