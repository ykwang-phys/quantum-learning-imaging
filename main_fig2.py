...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 21 21:13:05 2024
...
for i in range(Q):
    ...
    CT_array1_1[i]=CT_temp1
print ('direct imaging')   


CT_array2_1=np.zeros(Q)
...
for i in range(Q):
    ...
    CT_temp=C_T(temp1[-6:],alpha,S[i])
    #print (i,CT_temp1,CT_temp)
    CT_array1_2[i]=CT_temp1
print ('direct imaging')   


CT_array2_2=np.zeros(Q)
...
for i in range(Q):
    ...
    CT_temp=C_T(temp1[-6:],alpha,S[i])
    #print (i,CT_temp1,CT_temp)
    CT_array1_3[i]=CT_temp1
print ('direct imaging')   


CT_array2_3=np.zeros(Q)
...
plt.semilogx(S,CT_array1_1,linewidth=2,linestyle='-',label='direct alpha    ', color='royalblue')
plt.semilogx(S,CT_array1_3,linewidth=2,linestyle='-.',label='direct alpha    ', color='royalblue')
plt.semilogx(S,CT_array2_1,linewidth=2,linestyle='dotted',label='SPADE alpha    ', color='darkorange')

#plt.semilogx(S,CT_array1_2,linewidth=2,linestyle='-',label='direct')
#plt.semilogx(S,CT_array2_2,linewidth=2,linestyle='dotted',label='SPADE')


plt.semilogx(S,CT_array2_3,linewidth=2,linestyle='dashed',label='SPADE alpha    ', color='darkorange')
