...
#2024.11.08
#one source case, gd_generation_beta_k
Mmax=50
W=100
...
foo_fig.savefig('gd_direct_beta_Mmax'+str(Mmax)+'W'+str(W)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
...
foo_fig = plt.gcf() # 'get current figure'
foo_fig.savefig('gd_SPADE_beta_Mmax'+str(Mmax)+'W'+str(W)+'.jpg', format='jpg', dpi=1000,bbox_inches = 'tight')
