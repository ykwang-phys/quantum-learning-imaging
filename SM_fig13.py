...
xarray=np.linspace(1,C,C)

#k_array=np.linspace(0,11,12)
...
plt.xlim([-1,13])
plt.ylim([1e2,1e16])
#plt.semilogy(k_array,1/l3[-12:,0][::-1]-1, label='1_____', linewidth=3,linestyle='-')
#plt.semilogy(k_array,1/l3[-12:,1][::-1]-1, label='2_____', linewidth=3,linestyle='--')
#plt.semilogy(k_array,1/l3[-12:,2][::-1]-1, label='3_____', linewidth=3,linestyle='-.')

plt.semilogy(xarray,(1/np.abs(l3[-C-1:,0])-1)[::-1][-C:],linewidth=2,linestyle='-',label='alpha=0.1')
plt.semilogy(xarray,(1/np.abs(l3[-C-1:,1])-1)[::-1][-C:],linewidth=2,linestyle='--',label='alpha=0.01')
plt.semilogy(xarray,(1/np.abs(l3[-C-1:,2])-1)[::-1][-C:],linewidth=2,linestyle='-.',label='alpha=0.001')
...
#plt.tight_layout()
#plt.savefig('oSPADE_val_plot'+str(index)+'.png', dpi=300, bbox_inches='tight')
plt.show()
